...
namespace Veracode.ApiClients.IdentityApi.Models
{
    ...
    public partial class ResourceOfRole
    {
        /// <summary>
        /// Initializes a new instance of the ResourceOfRole class.
        /// </summary>
        public ResourceOfRole()
        {
            CustomInit();
        }
        ...
        /// <param name="isInternal">Flag indicating whether this role is
        ...
        public ResourceOfRole(bool? assignedToProxyUsers = default(bool?), bool? isInternal = default(bool?), object _links = default(object), IList<Permission> permissions = default(IList<Permission>), bool? requiresToken = default(bool?), string roleDescription = default(string), string roleId = default(string), int? roleLegacyId = default(int?), string roleName = default(string), bool? teamAdminManageable = default(bool?))
        {
        ...
        /// <summary>
        /// Gets or sets flag indicating whether this role is internal or
        /// external.
        /// </summary>
