...
namespace Veracode.ApiClients.IdentityApi.Models
{
    ...
    public partial class ResourceOfBusinessUnit
    {
        /// <summary>
        /// Initializes a new instance of the ResourceOfBusinessUnit class.
        /// </summary>
        public ResourceOfBusinessUnit()
        {
            CustomInit();
        }
        ...
        public ResourceOfBusinessUnit(string buId = default(string), int? buLegacyId = default(int?), string buName = default(string), bool? isDefault = default(bool?), object _links = default(object), ResourceOfOrganizationSummary organization = default(ResourceOfOrganizationSummary), IList<ResourceOfTeamResourceSummary> teams = default(IList<ResourceOfTeamResourceSummary>))
        {
            BuId = buId;
        ...
        public IList<ResourceOfTeamResourceSummary> Teams { get; set; }
