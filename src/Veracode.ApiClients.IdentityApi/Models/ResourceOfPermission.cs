...
namespace Veracode.ApiClients.IdentityApi.Models
{
    ...
    public partial class ResourceOfPermission
    {
        /// <summary>
        /// Initializes a new instance of the ResourceOfPermission class.
        /// </summary>
        public ResourceOfPermission()
        {
            CustomInit();
        }
        ...
        /// Identity API</param>
        public ResourceOfPermission(object _links = default(object), string permissionDescription = default(string), string permissionId = default(string), int? permissionLegacyId = default(int?), string permissionName = default(string), IList<string> permissionTypes = default(IList<string>))
        {
            this._links = _links;
