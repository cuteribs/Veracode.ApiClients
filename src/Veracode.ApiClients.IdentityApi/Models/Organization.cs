...
namespace Veracode.ApiClients.IdentityApi.Models
{
    ...
    public partial class Organization
    {
        ...
        /// deleted.</param>
        /// <param name="internalProperty">Flag indicating if this organization
        /// is internal or external.</param>
        ...
        public Organization(int? apiCredentialTtl = default(int?), bool? deleted = default(bool?), IList<Feature> features = default(IList<Feature>), bool? internalProperty = default(bool?), bool? loginEnabled = default(bool?), string oktaGroupId = default(string), string orgId = default(string), int? orgLegacyId = default(int?), string orgName = default(string), string orgStatus = default(string), string orgType = default(string), string salesLeadEmail = default(string), string salesLeadName = default(string), bool? samlEnabled = default(bool?), IList<OrganizationSku> skus = default(IList<OrganizationSku>), string solutionsArchitectEmail = default(string), string solutionsArchitectName = default(string), bool? useOkta = default(bool?), IList<User> users = default(IList<User>), string vendorContactEmail = default(string), string vendorContactJobTitle = default(string), string vendorContactName = default(string), string vendorDisplayName = default(string), string vendorType = default(string))
        {
        ...
        /// <summary>
        /// Gets or sets flag indicating if this organization is internal or
        /// external.
        /// </summary>
